...
vlog ../../../psynth/core_rv32im_nodiv/results/processor.v
...
# Simulation
vsim -voptargs=+acc=lprn -t ps -sdfmax /tb/processor=../../../psynth/core_rv32im_nodiv/results/processor.sdf work.tb
do wave.do
vcd file core_rv32im_nodiv.vcd

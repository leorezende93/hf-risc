...
write_db ./results/${DESIGN_TOP}_pre_cts.dat
...
# Save design
write_db ./results/${DESIGN_TOP}_pos_cts.dat
...
write_db ./results/${DESIGN_TOP}_pos_route.dat
...
write_db ./results/${DESIGN_TOP}_pos_fix_fan.dat  
...
write_db ./results/${DESIGN_TOP}_pos_opt.dat
...
write_db ./results/${DESIGN_TOP}_pos_filler.dat
...
write_netlist ./results/${DESIGN_TOP}.v

# Generate outputs
extract_rc 
write_sdc ./results/${DESIGN_TOP}.sdc
write_sdf ./results/${DESIGN_TOP}.sdf
write_def -floorplan -netlist -routing ./results/${DESIGN_TOP}.def

# Generate reports
#report_summary -out_dir  ./results/${DESIGN_TOP}/summaryReport
report_power   -out_file ./results/${DESIGN_TOP}_power.txt -cap
report_area > ./results/${DESIGN_TOP}_area.txt
report_nets > ./results/${DESIGN_TOP}_nets.txt

set_db timing_analysis_check_type hold
report_timing > ./results/${DESIGN_TOP}_hold.txt

set_db timing_analysis_check_type setup
report_timing > ./results/${DESIGN_TOP}_setup.txt
